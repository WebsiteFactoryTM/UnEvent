    ...
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 pb-12 md:pb-16 max-w-6xl">
          <div className="glass-card p-4 sm:p-6 lg:p-8 space-y-12 md:space-y-20">
            {/* Cine suntem (Who We Are) */}
            <section className="space-y-6 md:space-y-8">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground text-center">Cine suntem</h2>

              <div className="max-w-4xl mx-auto space-y-4 md:space-y-6">
                <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed text-pretty">
                  UN:EVENT este un ghid urban viu și un marketplace pentru spații, servicii și evenimente din România.
                </p>

                <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed text-pretty">
                  Suntem o platformă care pune în legătură gazde (proprietari de locații), prestatori (DJ, foto-video,
                  catering, organizatori etc.) și publicul care caută unde și cum să-și organizeze momentele importante
                  — sau pur și simplu vrea să știe ce se întâmplă în oraș.
                </p>

                <div className="bg-muted/30 backdrop-blur-sm border border-border/50 rounded-lg p-4 sm:p-6 space-y-2 text-sm mt-6 md:mt-8">
                  <p className="text-muted-foreground">
                    <strong className="text-foreground">SC PIXEL FACTORY SRL</strong>
                  </p>
                  <p className="text-muted-foreground">CUI: 47452355 / Reg. Com.: J35/154/2023</p>
                  <p className="text-muted-foreground">Sediu social: Str. Bega, nr. 47, Ghiroda, Timiș</p>
                  <p className="text-muted-foreground">
                    E-mail:{" "}
            ...
            {/* Ce facem (What We Do) */}
            <section className="space-y-6 md:space-y-8">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground text-center">Ce facem</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                <div className="feature-card p-4 md:p-6 space-y-4 rounded-lg">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-foreground">Creezi contul</h3>
                ...
                <div className="feature-card p-4 md:p-6 space-y-4 rounded-lg">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-foreground">Publici listarea</h3>
                  <p className="text-sm md:text-base text-muted-foreground text-pretty">
                ...
                <div className="feature-card p-4 md:p-6 space-y-4 rounded-lg">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-foreground">Primești contacte/rezervări</h3>
                  <p className="text-sm md:text-base text-muted-foreground text-pretty">
                ...
                <div className="feature-card p-4 md:p-6 space-y-4 rounded-lg">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-foreground">Crești</h3>
                  <p className="text-sm md:text-base text-muted-foreground text-pretty">
            ...
            <section className="space-y-6 md:space-y-8">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground text-center">Pentru cine</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                <div className="feature-card p-4 md:p-6 space-y-4 rounded-lg">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-foreground">Gazde/Proprietari de spații</h3>
                  <p className="text-sm md:text-base text-muted-foreground text-pretty">
                ...
                <div className="feature-card p-4 md:p-6 space-y-4 rounded-lg">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-foreground">Prestatori</h3>
                  <p className="text-sm md:text-base text-muted-foreground text-pretty">
                ...
                <div className="feature-card p-4 md:p-6 space-y-4 rounded-lg">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-foreground">Organizatori</h3>
                  <p className="text-sm md:text-base text-muted-foreground text-pretty">
                ...
                <div className="feature-card p-4 md:p-6 space-y-4 rounded-lg">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-foreground">Public cu chef de viață</h3>
                  <p className="text-sm md:text-base text-muted-foreground text-pretty">
            ...
            <section className="space-y-6 md:space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                <div className="feature-card p-4 md:p-6 space-y-4 rounded-lg">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-foreground">Minimal</h3>
                  <p className="text-sm md:text-base text-muted-foreground text-pretty">
                ...
                <div className="feature-card p-4 md:p-6 space-y-4 rounded-lg">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-foreground">Mobile-first</h3>
                  <p className="text-sm md:text-base text-muted-foreground text-pretty">
                ...
                <div className="feature-card p-4 md:p-6 space-y-4 rounded-lg">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-foreground">Corect</h3>
                  <p className="text-sm md:text-base text-muted-foreground text-pretty">
                ...
                <div className="feature-card p-4 md:p-6 space-y-4 rounded-lg">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-foreground">Deschis</h3>
                  <p className="text-sm md:text-base text-muted-foreground text-pretty">
            ...
            <section className="space-y-6 md:space-y-8">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground text-center">Ce oferim</h2>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                <div className="feature-card p-4 md:p-6 space-y-4 rounded-lg bg-gradient-to-br from-blue-500/10 to-blue-600/5 border-blue-500/20">
                  <div className="w-12 h-12 rounded-full bg-blue-500/20 flex items-center justify-center">
                    <FaMapPin className="w-6 h-6 text-blue-500 feature-icon" />
                  </div>
                  <h3 className="text-lg md:text-xl font-bold text-foreground">Locații</h3>
                  <p className="text-sm md:text-base text-muted-foreground text-pretty">
                    de la săli de evenimente la grădini, studiouri, mansarde, ateliere
                  </p>
                </div>

                <div className="feature-card p-4 md:p-6 space-y-4 rounded-lg bg-gradient-to-br from-green-500/10 to-green-600/5 border-green-500/20">
                  <div className="w-12 h-12 rounded-full bg-green-500/20 flex items-center justify-center">
                    <FaMusic className="w-6 h-6 text-green-500 feature-icon" />
                  </div>
                  <h3 className="text-lg md:text-xl font-bold text-foreground">Servicii</h3>
                  <p className="text-sm md:text-base text-muted-foreground text-pretty">
                    DJ, trupe, foto-video, organizatori, decor, catering și altele
                  </p>
                </div>

                <div className="feature-card p-4 md:p-6 space-y-4 rounded-lg bg-gradient-to-br from-purple-500/10 to-purple-600/5 border-purple-500/20">
                  <div className="w-12 h-12 rounded-full bg-purple-500/20 flex items-center justify-center">
                    <FaCalendarDays className="w-6 h-6 text-purple-500 feature-icon" />
                  </div>
                  <h3 className="text-lg md:text-xl font-bold text-foreground">Evenimente</h3>
                  <p className="text-sm md:text-base text-muted-foreground text-pretty">
            ...
            {/* Beneficii (Benefits) */}
            <section className="space-y-6 md:space-y-8">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground text-center">Beneficii</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                <div className="feature-card p-4 md:p-6 space-y-4 rounded-lg">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-foreground">Reach real</h3>
                  <p className="text-sm md:text-base text-muted-foreground text-pretty">public relevant, localizat</p>
                </div>
                ...
                <div className="feature-card p-4 md:p-6 space-y-4 rounded-lg">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-foreground">Control</h3>
                  <p className="text-sm md:text-base text-muted-foreground text-pretty">
                ...
                <div className="feature-card p-4 md:p-6 space-y-4 rounded-lg">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-foreground">Instrumente utile</h3>
                  <p className="text-sm md:text-base text-muted-foreground text-pretty">
                ...
                <div className="feature-card p-4 md:p-6 space-y-4 rounded-lg">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-foreground">Timp câștigat</h3>
                  <p className="text-sm md:text-base text-muted-foreground text-pretty">
            ...
            <section className="space-y-6 md:space-y-8">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground text-center">Link-uri utile</h2>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 max-w-4xl mx-auto">
                <Link href="/termeni-si-conditii" className="group">
                  <div className="feature-card p-4 md:p-6 space-y-4 rounded-lg h-full">
                    <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                      <FaSquareCheck className="w-6 h-6 text-primary feature-icon" />
                    </div>
                    <h3 className="text-base md:text-lg font-bold text-foreground">Termeni și condiții</h3>
                  </div>
                </Link>
                ...
                <Link href="/politica-de-confidentialitate" className="group">
                  <div className="feature-card p-4 md:p-6 space-y-4 rounded-lg h-full">
                    ...
                    <h3 className="text-base md:text-lg font-bold text-foreground">Politica de confidențialitate</h3>
                  </div>
                </Link>
                ...
                <Link href="/politica-cookie" className="group">
                  <div className="feature-card p-4 md:p-6 space-y-4 rounded-lg h-full">
                    ...
                    <h3 className="text-base md:text-lg font-bold text-foreground">Politica de cookie</h3>
                  </div>
                </Link>
              </div>
            </section>
