...
export const metadata: Metadata = {
  ...
  description:
    "Această pagină nu există. Reveniți la pagina principală pentru a explora locații, servicii și evenimente.",
}
    ...
    <div className="relative min-h-screen flex items-center justify-center px-4 py-20">
      ...
      <div className="relative z-10 text-center max-w-2xl mx-auto">
        ...
        <div className="backdrop-blur-xl bg-background/80 border border-border/50 rounded-[10px] p-8 md:p-12 shadow-[0_8px_32px_0_rgba(0,0,0,0.12),0_2px_8px_0_rgba(0,0,0,0.08),inset_0_1px_0_0_rgba(255,255,255,0.05)]">
          {/* 404 Number */}
          <div className="mb-6">
            <h1 className="text-8xl md:text-9xl font-bold text-foreground/20 select-none">404</h1>
          </div>

          {/* Message */}
          <h2 className="text-2xl md:text-3xl font-semibold text-foreground mb-4">Această pagină nu există</h2>

          <p className="text-foreground/70 mb-8 text-base md:text-lg">
            Ne pare rău, dar pagina pe care o căutați nu a fost găsită. Poate a fost mutată sau nu mai există.
          </p>
