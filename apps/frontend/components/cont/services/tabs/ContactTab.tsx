    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Adaugă modalitățile prin care clienții te pot contacta
        </p>
      </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Adaugă linkurile către profilurile tale (opțional)
          </p>
        </div>
      ...
      <div className="p-4 border rounded-lg bg-muted/20">
        <p className="text-sm text-muted-foreground">
          ...
          de a fi contactat de potențialii clienți. Profilurile de social media te ajută să îți arăți 
          portofoliul și experiența.
        </p>
      </div>
    </div>
  )
