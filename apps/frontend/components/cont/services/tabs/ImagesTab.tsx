    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Adaugă imagini și videoclipuri care prezintă serviciile tale.
        </p>
      </div>

      {/* Featured Image */}
      <div className="space-y-3">
        <Label htmlFor="featured-image">Imagine profil</Label>
        <p className="text-sm text-muted-foreground">
          Imaginea principală care va apărea în listările de servicii
        </p>
      ...
      <div className="space-y-3">
        ...
        <p className="text-sm text-muted-foreground">
          Prezintă serviciile tale din diferite unghiuri și momente
        </p>
      ...
      <div className="space-y-3">
        ...
        <p className="text-sm text-muted-foreground">
          Adaugă videoclipuri de pe YouTube care prezintă serviciile tale
        </p>
