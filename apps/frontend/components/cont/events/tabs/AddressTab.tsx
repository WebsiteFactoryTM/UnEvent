...
export function AddressTab() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold mb-2">Locația evenimentului</h3>
        <p className="text-sm text-muted-foreground">
          Adaugă informații despre locul unde se va desfășura evenimentul.
        </p>
      </div>
      ...
      <div className="p-4 border rounded-lg bg-blue-50 dark:bg-blue-950/20">
        <p className="text-sm text-blue-900 dark:text-blue-100">
          <strong>Notă:</strong> Locația evenimentului va fi vizibilă pe hartă în pagina de eveniment. 
          Adresa exactă va ajuta participanții să găsească mai ușor locul desfășurării.
        </p>
      </div>
    </div>
  )
