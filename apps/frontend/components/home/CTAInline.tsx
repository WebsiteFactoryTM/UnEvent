        ...
        <div className="text-center space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="glow-on-hover">
              <Link href="/cont/locatii/adauga">
                <FaLocationDot className="mr-2 h-5 w-5" />
                Listează o locație
              </Link>
            </Button>

            <Button asChild size="lg" variant="outline" className="glow-on-hover bg-transparent">
              <Link href="/cont/servicii/adauga">
            ...
            <Button asChild size="lg" variant="outline" className="glow-on-hover bg-transparent">
              <Link href="/cont/evenimente/adauga">
