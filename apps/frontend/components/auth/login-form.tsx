  ...
  const onSubmit = (data: LoginFormData) => {
    login(data, {
      onSuccess: (response) => {
        toast({
          title: "Succes",
          description: response.message || "Autentificat cu succes.",
        })
        // TODO: Navigate to desired destination (e.g., dashboard)
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <a href="/auth/recuperare-parola" className="text-sm underline underline-offset-4 hover:text-primary">
          Ai uitat parola?
        </a>
      </div>
