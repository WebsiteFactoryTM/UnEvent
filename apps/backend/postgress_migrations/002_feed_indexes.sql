...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "locations_status_idx" ON "locations" ("status");
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "services_status_idx" ON "services" ("status");
