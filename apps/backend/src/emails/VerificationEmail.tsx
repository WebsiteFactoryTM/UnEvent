...
export function VerificationEmail({ user, token }: VerificationEmailProps) {
  ...
  return (
    <EmailLayout preview="Bine ai venit la UN:EVENT — confirmă-ți emailul">
      ...
      <Text style={paragraph}>
        Te-ai înregistrat cu succes. Confirmă adresa de email pentru a-ți activa contul și a folosi
      ...
      <Text style={paragraphSmall}>
        Dacă nu ai creat tu acest cont, poți ignora acest email sau ne poți scrie la {supportEmail}.
      </Text>
